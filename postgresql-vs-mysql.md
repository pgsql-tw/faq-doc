...
![](.gitbook/assets/postgresql-vs-mysql.png)

PostgreSQL 和 MySQL 之間有一些根本上的差別。 你只有在評估兩個系統之間的差異和取捨之後，才做出明智的決定。

我們提供了PostgreSQL和MySQL之間最常見的特性和能力的相似點和不同點的總結：

* [Open Source](postgresql-vs-mysql.md#open-source)
* [Acid Compliance](postgresql-vs-mysql.md#acid-compliance)
* [SQL Compliance](postgresql-vs-mysql.md#sql-compliance)
* [Replication](postgresql-vs-mysql.md#replication)
* [Performance](postgresql-vs-mysql.md#performance)
* [Security](postgresql-vs-mysql.md#security)
* [Cloud Hosting](postgresql-vs-mysql.md#cloud-hosting)
* [Community Support](postgresql-vs-mysql.md#community-support)
* [Concurrency Support](postgresql-vs-mysql.md#concurrency-support)
* [NoSQL/JSON Support](postgresql-vs-mysql.md#nosql-featuresjson-support)
* [Materialized Views & Temporary Tables](postgresql-vs-mysql.md#materialized-viewstemporary-tables)
* [GeoSpatial Data Support](postgresql-vs-mysql.md#geospatial-data-support)
* [Programming Languages Support](postgresql-vs-mysql.md#programming-languages-support)
* [Extensible Type System](postgresql-vs-mysql.md#extensible-type-system)
* [Comparison Summary](postgresql-vs-mysql.md#comparison-summary)
